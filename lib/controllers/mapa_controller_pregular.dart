...
import 'package:projeto_hpg/pages/Mapa/mapa_page_pregular.dart';
import '../database/db.dart';
import '../widgets/hidrante_details.dart';
import '../widgets/hidrante_detalhes.dart';

class MapaControllerPRegular extends GetxController {
  ...
  static MapaControllerPRegular get to => Get.find<MapaControllerPRegular>();
  ...
  loadHidrantesRegular() async {
    ...
    final hidrantes =
        await _hidranteRef.where('pressao', isEqualTo: 'Regular').get();
      ...
      Marker(
        ...
        onTap: () => {
          showModalBottomSheet(
            context: appKeyRegular.currentState!.context,
