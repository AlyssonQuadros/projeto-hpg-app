...
import 'package:projeto_hpg/controllers/mapa_controller_pregular.dart';
...
class MapaPagePRegular extends StatefulWidget {
  const MapaPagePRegular({Key? key}) : super(key: key);

  @override
  State<MapaPagePRegular> createState() => _MapaPagePRegularState();
}
...
class _MapaPagePRegularState extends State<MapaPagePRegular> {
  ...
  filtro() {
    return SimpleDialog(
      ...
      children: [
        // Obx(
        //   () => Slider(
        //     value: MapaControllerPRegular.to.raio.value,
        //     min: 0,
        //     max: 10,
        //     divisions: 10000,
        //     label: MapaControllerPRegular.to.distancia,
        //     onChanged: (value) => MapaControllerPRegular.to.raio.value = value,
        //   ),
        // ),
        Padding(
          padding: EdgeInsets.only(bottom: 0),
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MapaControllerPRegular());
    final user = FirebaseAuth.instance.currentUser!;
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        GetBuilder<MapaControllerPRegular>(
          init: controller,
  ...
  Future<void> _handlePressButton() async {
    ...
    displayPrediction(p!, homeScaffoldKeyRegular.currentState);
  }
  ...
  void onError(PlacesAutocompleteResponse response) {
    ...
    // homeScaffoldKeyRegular.currentState!.showSnackBar(SnackBar(content: Text(response.errorMessage!)));
  }
