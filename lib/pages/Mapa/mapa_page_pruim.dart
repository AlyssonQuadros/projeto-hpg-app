...
final appKeyRuim = GlobalKey();
final user = FirebaseAuth.instance.currentUser!;

class MapaPagePRuim extends StatefulWidget {
  const MapaPagePRuim({Key? key}) : super(key: key);

  @override
  State<MapaPagePRuim> createState() => _MapaPagePRuimState();
}

final homeScaffoldKeyRuim = GlobalKey<ScaffoldState>();

class _MapaPagePRuimState extends State<MapaPagePRuim> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MapaControllerPRuim());
    final user = FirebaseAuth.instance.currentUser!;
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        GetBuilder<MapaControllerPRuim>(
          init: controller,
  ...
  Future<void> _handlePressButton() async {
    ...
    displayPrediction(p!, homeScaffoldKeyRuim.currentState);
  }
  ...
  void onError(PlacesAutocompleteResponse response) {
    ...
    // homeScaffoldKeyRuim.currentState!.showSnackBar(SnackBar(content: Text(response.errorMessage!)));
  }
