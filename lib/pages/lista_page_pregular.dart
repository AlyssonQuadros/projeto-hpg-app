...
class ListaPagePRegular extends StatefulWidget {
  const ListaPagePRegular({super.key});

  @override
  State<ListaPagePRegular> createState() => _ListaPagePRegularState();
}

class _ListaPagePRegularState extends State<ListaPagePRegular> {
                  ...
                  Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          ...
                          .where('pressao', isEqualTo: 'Regular')
                          .snapshots(),
                      builder: (context,
